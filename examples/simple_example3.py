...
# Load the dataset
url = "https://raw.githubusercontent.com/Techtonique/datasets/refs/heads/main/tabular/triangle/christofides2007cumul.csv"
df = pd.read_csv(url)

# Ensure the data has the required columns
df = df.rename(columns={
    'origin': 'originf',  # Rename origin to originf
    'dev': 'dev',        # Keep dev as is
    'value': 'value'     # Keep value as is
})

# Ensure all required columns are present
required_cols = ['originf', 'dev', 'value']
